...
JNIEXPORT void JNICALL
    Java_com_inanna_openglpolygon_PolygonJNI_onSurfaceCreated(JNIEnv *env, jclass type) {
        (void) type;
        triangulate();
        createSurface();
    }
...
extern "C" {
JNIEXPORT void JNICALL
    Java_com_inanna_openglpolygon_PolygonJNI_onDrawFrame(JNIEnv *env, jclass type, jfloat red, jfloat green, jfloat blue) {
        (void) type;
...
extern "C" {
JNIEXPORT void JNICALL
    Java_com_inanna_openglpolygon_PolygonJNI_onSurfaceChanged(JNIEnv *env, jclass type) {
        (void) type;
...
extern "C" {
JNIEXPORT void JNICALL
    Java_com_inanna_openglpolygon_PolygonJNI_pushToVertices(JNIEnv *env, jclass type, jfloat x, jfloat y) {
        (void) type;
